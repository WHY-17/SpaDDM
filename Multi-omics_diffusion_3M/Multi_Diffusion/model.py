...
class Multi_Omics_DDM(nn.Module):
    def __init__(
        ...
        self.DDM_omics_1_image = DDM(in_dim=self.in_dim_omics_1, num_hidden=self.num_hidden_omics_1,
                                     num_layers=num_layers, nhead=nhead, activation=activation,
                                     feat_drop=feat_drop, attn_drop=attn_drop,
                                     norm=norm, alpha_l=alpha_l,
                                     beta_schedule=beta_schedule, beta_1=beta_1,
                                     beta_T=beta_T, T=T)



        self.atten_cross = AttentionLayer_triplet(self.num_hidden_omics_1, self.num_hidden_omics_2)
        ...
        self.dec_cross_image = Cross_Decoder(self.num_hidden_omics_1, self.in_dim_omics_1)
    ...
    def forward(self, dgl_omics_1, dgl_omics_2):
        ...
        loss_rec_image = self.DDM_omics_1_image(dgl_omics_1, dgl_omics_1.ndata['image'])
        ...
        emb_image = self.DDM_omics_1_image.embed(dgl_omics_1, dgl_omics_1.ndata['image'], 100)

        # between-omics attention aggregation layer
        emb_combined, alpha = self.atten_cross(emb_omics_1, emb_omics_2, emb_image)
        ...
        comb_recon_image = self.dec_cross_image(emb_combined, dgl_omics_1.adj().to_dense())
        ...
        results = {'emb_omics_1': emb_omics_1,
                   ...
                   'comb_recon_image': comb_recon_image,
                   'loss_rec_omics_1': loss_rec_1,
                   'loss_rec_omics_2': loss_rec_2,
                   'loss_rec_image': loss_rec_image,
                   # 'loss_rec_omics_2_image': loss_rec_2_image,
