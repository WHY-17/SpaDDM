...
def construct_neighbor_graph(adata_omics1, adata_omics2, datatype='SPOTS', n_neighbors=3): 
    ...
    ################# spatial graph #################
    if datatype in ['Stereo-CITE-seq', 'Spatial-epigenome-transcriptome', 'Spatial CITE-seq']:
       n_neighbors=6 
    # omics1
    ...
    data = {'adata_omics_1': adata_omics1, 'adata_omics_2': adata_omics2}
...
def adjacent_matrix_preprocessing(adata_omics1, adata_omics2):
    ...
    adj = {'adj_spatial_omics_1': adj_spatial_omics1,
           'adj_spatial_omics_2': adj_spatial_omics2,
